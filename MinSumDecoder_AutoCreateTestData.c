...
/*  幫我寫一個讀取Alist，從codeword=1010101010.....10101010一零交錯下一個(+1)開始硬解，生成一個非全0合法codeword的C與言程式      */
...
{
    char filename[100]={"C:\\Users\\09043\\OneDrive\\Python\\LDPC\\GallagerH.txt"};
...
int main(void)
{
    ...
    const int deocder_iteration_max = 10000;
    const double EbN0_dB = 5;
